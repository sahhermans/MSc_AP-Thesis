...
u_1 = mda.Universe("out.1.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
u_2 = mda.Universe("out.2.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
u_3 = mda.Universe("out.3.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
u_4 = mda.Universe("out.4.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
u_5 = mda.Universe("out.5.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
u_6 = mda.Universe("out.6.lammpstrj", topology_format='LAMMPSDUMP',lengthunit="A", timeunit="fs")
